            ...
            control.container.on( 'click', '.ast-toggle-desc-wrap .ast-adv-toggle-icon', function( e ) {
				...
				if( ! preview_body.hasClass('ast-woo-cart-preview-style') ) {
					if( astraCustomizerControlBackground.isSiteRTL ) {
						var output = "<style type='text/css' id='ast-woo-cart-preview-style'> .woocommerce .ast-site-header-cart .widget_shopping_cart, .ast-site-header-cart .widget_shopping_cart {transition: 0s;} .open-preview-woocommerce-cart #masthead #ast-site-header-cart .widget_shopping_cart {left: auto;right: -10px;transition: 0s;opacity: 1;margin-top: 10px;visibility: visible;}.open-preview-woocommerce-cart #masthead #ast-site-header-cart .widget_shopping_cart:before {right: 15px;right: auto;}.open-preview-woocommerce-cart #masthead #ast-site-header-cart .widget_shopping_cart:after {display: none;} </style>";
					} else {
						var output = "<style type='text/css' id='ast-woo-cart-preview-style'> .woocommerce .ast-site-header-cart .widget_shopping_cart, .ast-site-header-cart .widget_shopping_cart {transition: 0s;} .open-preview-woocommerce-cart #masthead #ast-site-header-cart .widget_shopping_cart {right: auto;left: -10px;transition: 0s;opacity: 1;margin-top: 10px;visibility: visible;}.open-preview-woocommerce-cart #masthead #ast-site-header-cart .widget_shopping_cart:before {left: 15px;right: auto;}.open-preview-woocommerce-cart #masthead #ast-site-header-cart .widget_shopping_cart:after {display: none;} </style>";
					}
