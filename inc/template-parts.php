...
if ( ! function_exists( 'astra_footer_small_footer_template' ) ) {
	...
	function astra_footer_small_footer_template() {
		...
		$small_footer_layout = apply_filters( 'ast_footer_sml_layout', $small_footer_layout ); // phpcs:ignore WPThemeReview.CoreFunctionality.PrefixAllGlobals.NonPrefixedHooknameFound
