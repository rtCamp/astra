...
if ( ! function_exists( 'astra_get_audios_from_post' ) ) {
	...
	function astra_get_audios_from_post( $post_id ) {
		...
		$content = do_shortcode( apply_filters( 'the_content', $post->post_content ) );// phpcs:ignore WPThemeReview.CoreFunctionality.PrefixAllGlobals.NonPrefixedHooknameFound
